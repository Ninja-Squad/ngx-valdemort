                        ...
                        <a href="modules/ValdemortModule.html" data-type="entity-link">ValdemortModule</a>
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#components-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' : 'data-target="#xs-components-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' }>
                                    <span class="icon ion-md-cog"></span>
                                    <span>Components</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="components-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' : 'id="xs-components-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' }>
                                        <li class="link">
                            ...
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#directives-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' : 'data-target="#xs-directives-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' }>
                                    <span class="icon ion-md-code-working"></span>
                                    <span>Directives</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="directives-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' : 'id="xs-directives-links-module-ValdemortModule-36b6bca190d9c7c0f414b5ae52c21f18"' }>
                                        <li class="link">
